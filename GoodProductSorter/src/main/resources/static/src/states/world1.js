...
GoodProductSorter.world1State.prototype = {
	...
	resize: function () {
		...
		this.button_lvl1.x =0+this.world.width*0.15;
		...
		this.text1.setTextBounds(this.button_lvl1.x+this.button_lvl1.width/3, this.button_lvl1.y+this.button_lvl1.height, this.button_lvl1.x,100);
		...
		this.button_lvl2.y = this.button_lvl1.y + game.world._height * 0.1;
