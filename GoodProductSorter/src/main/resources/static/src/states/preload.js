...
/*		if(game.global.DEBUG_MODE)
	...
	preload : function() {
		this.loading =this.add.image(this.game.width*0.5, this.game.height*0.5, "logo");
		//Escalado
	...
	loadAssets:function(){
		...
		this.load.image("empleadoDelMes", 'assets/images/interface/EmpleadoDelMesPoster.png')
		...
		game.load.spritesheet('ssflecha', 'assets/images/scenario/SSFlecha.png', 39, 19, 2);
